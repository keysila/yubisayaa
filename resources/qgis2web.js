...
map.getView().fit([12105624.381578, -849403.100331, 12111584.630250, -845933.707706], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA DESA PATMUAN</h2>';
        return titleElement;
    })(),
